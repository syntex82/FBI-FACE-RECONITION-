...
| **[QUICK_START_GUIDE.md](QUICK_START_GUIDE.md)** | ⚡ Quick start for beginners |
| **[HOW_TO_ADD_PEOPLE.md](HOW_TO_ADD_PEOPLE.md)** | 👥 Adding people to database |
| **[FBI_DASHBOARD_GUIDE.md](FBI_DASHBOARD_GUIDE.md)** | 📊 Dashboard features |

**New users start here:** [INSTALLATION.md](INSTALLATION.md) → [USER_GUIDE.md](USER_GUIDE.md)
...
Start with: `python quick_add_person.py` to add yourself, then `python fbi_app_fixed.py` to test!